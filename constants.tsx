...
export const DEFAULT_TEMPLATE = `Olá {{nome_cliente}}, este é um lembrete amigável sobre sua mensalidade de {{valor}} com vencimento em {{vencimento}}. Você pode realizar o pagamento via Pix: {{chave_pix}}.`;
