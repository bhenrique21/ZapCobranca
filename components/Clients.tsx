                ...
                filteredClients.map((client) => (
                  <tr key={client.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 md:px-8 md:py-5 text-right flex items-center justify-end gap-1 md:gap-2">
                      <button onClick={() => handleWhatsAppClick(client)} className="p-2 md:p-2.5 bg-emerald-500 text-white rounded-lg md:rounded-xl hover:bg-emerald-600 transition-all">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl md:rounded-2xl p-4 flex items-center justify-between">
                <div className="pr-4">
                  <h4 className="text-xs md:text-sm font-bold text-slate-900 flex items-center gap-2">
                    <svg className="w-3.5 h-3.5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="w-10 h-5 md:w-11 md:h-6 bg-slate-200 rounded-full peer peer-checked:bg-emerald-500 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 md:after:h-5 after:w-4 md:after:w-5 after:transition-all"></div>
                </label>
              </div>
