...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onLogin }) => {
  ...
  const mockChartData = [
    { name: 'Set/24', pago: 4500 },
    { name: 'Out/24', pago: 6200 },
    { name: 'Nov/24', pago: 5800 },
    { name: 'Dez/24', pago: 7100 },
    { name: 'Jan/25', pago: 6900 },
    { name: 'Fev/25', pago: 8200 },
  ];
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2.5 cursor-pointer group" onClick={() => window.scrollTo(0, 0)}>
            <div className="w-10 h-10 bg-indigo-600 rounded-full flex items-center justify-center text-white font-black shadow-lg shadow-indigo-200 group-hover:scale-110 transition-transform">Z</div>
          ...
          <div className="hidden md:flex items-center gap-8">
             ...
             <a href="#pricing" className="text-sm font-semibold text-slate-600 hover:text-indigo-600 transition-colors">Preços</a>
      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
           <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-indigo-50 rounded-full blur-[100px] opacity-60 mix-blend-multiply"></div>
           <div className="absolute bottom-[10%] left-[-10%] w-[600px] h-[600px] bg-purple-50 rounded-full blur-[120px] opacity-60 mix-blend-multiply"></div>
        </div>

        <div className="max-w-4xl mx-auto flex flex-col items-center text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-full mb-8 shadow-sm hover:border-indigo-200 transition-colors cursor-default">
              <span className="flex h-2 w-2 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
              </span>
              <span className="text-xs font-bold uppercase tracking-wider text-slate-600">Gestão Simples e Eficiente</span>
            </div>
            
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold text-slate-900 leading-[1.1] tracking-tight mb-8">
              Organize suas cobranças e <br />
            ...
            <div className="mt-10 flex items-center gap-8 text-sm font-semibold text-slate-400">
        ...
        <div className="mt-20 max-w-7xl mx-auto relative z-10 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
           <div className="absolute -inset-1 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-[2.5rem] blur-xl opacity-20"></div>
           <div className="relative bg-[#F8FAFC] border-[6px] md:border-[10px] border-white rounded-[2rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden">
               ...
               <div className="bg-white px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                  ...
                  <div className="hidden md:block h-6 w-64 bg-slate-50 rounded-lg border border-slate-100 flex items-center justify-center text-[10px] text-slate-400 font-medium">
                    app.zapcobranca.com.br/dashboard
                  </div>
                  <div className="h-8 w-8 rounded-full bg-indigo-600 flex items-center justify-center text-white text-xs font-bold">U</div>
               </div>
               
               {/* CONTEÚDO FIEL AO DASHBOARD.TSX */}
               <div className="p-6 md:p-8 space-y-6">
                   {/* Header do App */}
                   <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      <div>
                        <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter">Status Financeiro</h2>
                        <p className="text-xs text-slate-500 font-medium">Acompanhamento de fluxo de caixa (Regime de Caixa).</p>
                      </div>
                      <div className="flex gap-2">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {/* Dark Hero Card */}
                      <div className="bg-slate-900 p-6 rounded-[1.5rem] shadow-xl text-white relative overflow-hidden">
                         ...
                         <div className="relative z-10">
                            <div className="inline-flex items-center gap-2 bg-indigo-500/20 border border-indigo-500/30 px-2 py-1 rounded-full mb-3">
                               ...
                               <span className="text-[8px] font-bold uppercase tracking-widest text-indigo-300">Faturamento Previsto</span>
                            </div>
                            <p className="text-3xl font-black tracking-tight">R$ 12.450,00</p>
                      ...
                      {/* Green Card */}
                      <div className="bg-emerald-500 p-6 rounded-[1.5rem] shadow-xl text-white relative overflow-hidden">
                          <p className="text-[8px] font-black uppercase tracking-[0.2em] opacity-80">Recebido (Caixa)</p>
                          <p className="text-3xl font-black mt-2 tracking-tight">R$ 8.200,00</p>
                          <p className="text-[9px] font-bold mt-3 opacity-80">5 pagamentos confirmados</p>
                      </div>

                      {/* White Card 1 */}
                      <div className="bg-white p-6 rounded-[1.5rem] border border-slate-200 shadow-sm">
                          <p className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em]">Pendente / Aberto</p>
                          <p className="text-3xl font-black text-slate-900 mt-2 tracking-tight">R$ 4.250,00</p>
                          <p className="text-[9px] font-black text-amber-500 mt-3 uppercase tracking-tighter">Aguardando 3 transações</p>
                      </div>

                      {/* White Card 2 */}
                      <div className="bg-white p-6 rounded-[1.5rem] border border-slate-200 shadow-sm">
                          <p className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em]">Ticket Médio</p>
                          <p className="text-3xl font-black text-slate-900 mt-2 tracking-tight">R$ 1.556,00</p>
                   ...
                   <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      <div className="lg:col-span-2 bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm h-[300px] flex flex-col">
                          <div className="mb-4">
                             <h3 className="text-lg font-black text-slate-800">Receita Realizada</h3>
                             <p className="text-[10px] text-slate-400 font-bold uppercase">Últimos 6 meses</p>
                          </div>
                          <div className="flex-1 w-full">
                            <ResponsiveContainer width="100%" height="100%">
                              <BarChart data={mockChartData}>
                                ...
                                />
                                <Bar dataKey="pago" fill="#10b981" radius={[6, 6, 6, 6]} barSize={30} />
                              </BarChart>
                            </ResponsiveContainer>
                          </div>
                      </div>

                      <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm flex flex-col h-[300px]">
                          <div className="mb-4">
                             <h3 className="text-lg font-black text-slate-800">Detalhe Mensal</h3>
                             <p className="text-[10px] text-slate-400 font-bold uppercase">Pagamentos de Fevereiro</p>
                          </div>
                          <div className="space-y-3 overflow-hidden relative">
                             ...
                             <div className="flex justify-between items-center p-2 opacity-60">
                                <span className="font-bold text-slate-700 text-xs">Dev Freelance</span>
                                <span className="font-black text-emerald-600 text-xs">R$ 1.500</span>
                             </div>
                          </div>
                      </div>
                   </div>
      ...
      {/* --- FEATURES SECTION (Updated to Grid) --- */}
      <section id="features" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-slate-900">Gerencie menos, receba mais.</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 border border-slate-100 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Economia de Tempo</h3>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 border border-slate-100 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Organização Total</h3>
              <p className="text-slate-500 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 border border-slate-100 group">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Taxa Zero no Pix</h3>
              <p className="text-slate-500 leading-relaxed">
      ...
      <section id="pricing" className="py-24 px-4 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6">Planos que cabem no bolso.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
            {(Object.keys(PLANS) as Array<keyof typeof PLANS>).map((key) => {
              ...
              return (
                <div 
                  key={key} 
                  className={`relative p-10 rounded-[2.5rem] transition-all duration-300 flex flex-col h-full
                    ${isRecommended 
                      ? 'bg-slate-900 text-white shadow-2xl scale-105 z-10 ring-8 ring-slate-900/10' 
                ...
                >
                  ...
                  <div className="mb-8">
                     ...
                     <div className="flex items-baseline gap-1">
                        ...
                        <span className={`text-sm font-bold ${isRecommended ? 'text-slate-400' : 'text-slate-400'}`}>/mês</span>
                     </div>
                     <p className={`mt-4 text-sm font-medium ${isRecommended ? 'text-slate-400' : 'text-slate-500'}`}>
                        {plan.description}
                     </p>
                  </div>
                  ...
                  <ul className="space-y-4 mb-10 flex-1">
                    <li className="flex items-center gap-3 text-sm font-bold">
                      <div className={`w-5 h-5 rounded-full flex items-center justify-center ${isRecommended ? 'bg-indigo-500/20 text-indigo-400' : 'bg-indigo-50 text-indigo-600'}`}>✓</div>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="bg-white border border-slate-200 rounded-[20px] overflow-hidden transition-all hover:border-indigo-200">
                <button 
                  onClick={() => toggleFaq(i)}
                  className="w-full flex items-center justify-between p-6 text-left font-bold text-slate-800 text-base md:text-lg"
                >
                  <span className="pr-4">{item.q}</span>
                  <div className={`w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center transition-transform duration-300 ${openFaq === i ? 'rotate-180 bg-indigo-100 text-indigo-600' : 'text-slate-400'}`}>
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                  </div>
                </button>
                {openFaq === i && (
                  <div className="px-6 pb-6 text-slate-500 leading-relaxed font-medium animate-in slide-in-from-top-1">
                    {item.a}
                  </div>
                )}
              </div>
        ...
        <div className="max-w-5xl mx-auto">
           <div className="bg-slate-900 rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-8 text-xs font-bold text-slate-500 uppercase tracking-widest">Sem compromisso • Sem cartão</p>
              </div>
           </div>
        </div>
      </section>
